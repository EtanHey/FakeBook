...
exports.isUserLoggedIn = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var host, cookie, currentUserInfo, currentUser, error_4;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2,, 3]);
          ...
          return [4
          /*yield*/
          , userModel_1["default"].findById(currentUserInfo.id, {
            password: 0
          })];
        ...
        case 1:
          ...
          if (!currentUser) {
            res.send({
              ok: false,
              message: 'no user was found using your cookies'
            });
            return [2
            /*return*/
            ];
