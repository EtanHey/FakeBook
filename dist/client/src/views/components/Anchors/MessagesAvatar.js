...
function MessagesAvatar(props) {
    ...
    return (<framer_motion_1.motion.div>
      <material_1.Avatar style={AvatarStyling} onClick={(ev) => handleOpenNavPopover(ev)}>
        <react_fontawesome_1.FontAwesomeIcon size="xs" icon={["fas", "comment-dots"]}/>
      </material_1.Avatar>

    </framer_motion_1.motion.div>);
}
exports.default = MessagesAvatar;
//# sourceMappingURL=MessagesAvatar.js.map